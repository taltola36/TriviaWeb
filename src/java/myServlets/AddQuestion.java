...
//        response.addCookie(lastName);
        ...
        if (request.getParameterMap().containsKey("backToDifficultyLevel")) {
            ...
            out.print("<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                    ...
                    + "<input type='radio' name='difficultLevel' value='medium'>Medium<br>");
        ...
        if (request.getParameterMap().containsKey("backToTypeQuestion")) {
            ...
            out.print("<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                    + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                    + "<input type='radio' name='questionType' value='yesNo'>Yes or no questions<br>");
        ...
        if (request.getParameterMap().containsKey("AddMultiAnswers")) {
            ...
            if (!flag && !request.getParameter("Rightanswer").equals("")) {
                ...
                out.print("<form><br>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='addAnother' value='Add another question'><br></form></center></div>");                       
            }
            type = "Nothing";
        }
        if (request.getParameterMap().containsKey("backToMultiAnswers")) {
            ...
            if (numberOfOptions < 6)        
                ...
                out.print("<div style='background-color:darkseagreen;height:"+(68+numberOfOptions/1.1)+"%;width:17%;float:left;font-size:100%'>");   
            ...
            out.print("<br>1. <input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                    + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                    + "<input type='text' name='Rightanswer' style='width:10cm'><br>");                
        ...
        if (request.getParameterMap().containsKey("AddNumberOfOptions")) {
            if (request.getParameter("numberOfOptions").equals("") || Integer.parseInt(request.getParameter("numberOfOptions")) > 10 || Integer.parseInt(request.getParameter("numberOfOptions")) < 1) {
                out.print("<body style='background-color:darkseagreen; font-family: Times New Roman; font-size:130%'>");
                out.print("<div style='height:5%;width:10%;float:top'>");
                out.print("<img src='http://www.smartlabtoys.com/media/chalkboard/chalkboard-trivia-overlay.png' style='width:300px;height:80px'></div>");
                out.print("<body><div style='margin-top: -0.5cm;margin-right:1cm;float:right'>Hello, "
                        +request.getParameter("fname")+" "+request.getParameter("lname")  +"</div>");
                ...
                out.print("<div style='margin-right:6cm;'><font size='5'><center>Something went wrong.<br> Please type the number of answers you have.<br> The maximum is 10.</center></div>");
                out.print("<br><div style='margin-right:6cm'><center><form>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='backToNumberOfOptions' value='back' style='width:80px; font-size:16px'></form></center></div>");
                type = "Nothing";
            }
            else {
                out.print("<body style='background-color:lightgoldenrodyellow; font-family: Times New Roman; font-size:120%'>");
                ...
                if (Integer.parseInt(request.getParameter("numberOfOptions")) < 6)
                    out.print("<div style='background-color:darkseagreen;height:68%;width:16.7%;float:left;font-size:100%'>");
                else
                    out.print("<div style='background-color:darkseagreen;height:"+(68+Integer.parseInt(request.getParameter("numberOfOptions"))/1.1)+"%;width:17%;float:left;font-size:100%'>");
                ...
                if (Integer.parseInt(request.getParameter("numberOfOptions")) > 1)
                ...
                out.print("<br><input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='AddMultiAnswers' value='Add'>   <input type='submit' name='backToNumberOfOptions' value='change number of answers' style='width:5cm'><br>");
                out.print("</form></center></div>");
                type = "Nothing";
            }
        }
        ...
        if (type.equals("AddRightAnswer")) {
            if (request.getParameter("Rightanswer").equals("")){
                ...
                out.print("<br><div style='margin-right:6cm'><center><form>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='backToRightAnswer' value='back' style='width:80px; font-size:16px'></form></center></p>");
            }
            else {
                out.print("<body style='background-color:lightgoldenrodyellow; font-family: Times New Roman; font-size:120%'>");
                out.print("<div style='height:5%;width:10%;float:top'>");
                ...
                out.print("<div style='margin-right:6cm'><center>Your question has been successfully added<br>");
                out.print("<form><br><input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='addAnother' value='Add another question'><br></form></center></div>");             
            }            
        }
        ...
        if (type.equals("TypeQuestion") || request.getParameterMap().containsKey("backToNumberOfOptions") || request.getParameterMap().containsKey("backToRightAnswer") || request.getParameterMap().containsKey("backToNumberOfOptions")) {
            if (!request.getParameterMap().containsKey("questionType") && type.equals("TypeQuestion")){
                ...
                out.print("<br><div style='margin-right:6cm'><center><form>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='backToTypeQuestion' value='back' style='width:80px; font-size:16px'></form></center></div>");
            }
             else {
                out.print("<body style='background-color:lightgoldenrodyellow; font-family: Times New Roman; font-size:120%'>");
                out.print("<div style='height:5%;width:10%;float:top'>");
                ...
                if (request.getParameterMap().containsKey("backToNumberOfOptions") || (request.getParameterMap().containsKey("questionType") && request.getParameter("questionType").equals("multi"))) {
                    out.print("<div style='margin-right:6cm'><center><form>Type the number of answers you have.<br> The maximum is 10.<br><br><input type='text' style='width:2cm' name='numberOfOptions'><br><br>");             
                    out.print("<br><input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                            + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                            + "<input type='submit' name='AddNumberOfOptions' value='Add'><br></form></center></div>");
                }
                else {
                    ...
                    out.print("<br><input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                            + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                            + "<input type='submit' name='AddRightAnswer' value='Add'><br></form></center></div>");
                }
                    type = "Nothing";
            }
        ...
        if (type.equals("difficultyLevel")) {
            if (!request.getParameterMap().containsKey("difficultLevel") && type.equals("difficultyLevel")){
                ...
                out.print("<br><div style='margin-right:6cm'><center><form>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='backToDifficultyLevel' value='back' style='width:80px; font-size:16px'></form></center></div>");
            }
            else {
                out.print("<body style='background-color:lightgoldenrodyellow; font-family: Times New Roman; font-size:120%'>");
                out.print("<div style='height:5%;width:10%;float:top'>");
                ...
                out.print("<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='radio' name='questionType' value='multi'>Multiple options question<br>");
        ...
        if (type.equals("addQuestion") ) {
            if (request.getParameter("question").equals("") && type.equals("addQuestion")){
                ...
                out.print("<br><div style='margin-right:6cm'><center><form>"
                        + "<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='submit' name='backToQuestion' value='back' style='width:80px; font-size:16px'></form></center></div>");
            }
            else {
                out.print("<body style='background-color:lightgoldenrodyellow; font-family: Times New Roman; font-size:120%'>");
                out.print("<div style='height:5%;width:10%;float:top'>");
                ...
                out.print("<input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='radio' name='difficultLevel' value='medium'>Medium<br>"
                        + "<input type='radio' name='difficultLevel' value='hard'>Hard<br>");
                out.print("<br><input type='submit' name='difficultyLevel' value='Add'><br></form></center></div>");         
            }   
         }
         ...
         if (type.equals("okCategory") || request.getParameterMap().containsKey("backToQuestion")) {   //then show add question page
            if (!request.getParameterMap().containsKey("category") && type.equals("okCategory")){
                ...
                out.print("<form><br><input type='hidden' name='fname' value='"+request.getParameter("fname")+"'>"
                        + "<input type='hidden' name='lname' value='"+request.getParameter("lname")+"'>"
                        + "<input type='text' style='width:10cm' name='question'><br>");
